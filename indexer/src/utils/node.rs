...
#[cfg(target_os = "linux")]
static NEOGO_DL: &str =
    "https://github.com/nspcc-dev/neo-go/releases/download/v0.105.0/neo-go-linux-amd64";
#[cfg(target_os = "macos")]
static NEOGO_DL: &str =
    "https://github.com/nspcc-dev/neo-go/releases/download/v0.105.0/neo-go-darwin-arm64";
#[cfg(target_os = "windows")]
static NEOGO_DL: &str =
    "https://github.com/nspcc-dev/neo-go/releases/download/v0.105.0/neo-go-windows-amd64.exe";
